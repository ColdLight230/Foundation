...
public class Code_026_RemoveDuplicatesFromSortedArray {
    ...
    // 执行用时: 144 ms, 在Remove Duplicates from Sorted Array的Java提交中击败了4.66% 的用户
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new Code_026_RemoveDuplicatesFromSortedArray().removeDuplicates(nums));
